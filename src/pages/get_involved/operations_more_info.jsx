...
import './operations_more_info.css'; 
    ...
    return (
        <>
            ...
            <div className="operations-info-container">
                <h1>More Information About the Operations Team</h1>

                {/* Transportation Logistics Subteam */}
                <div className="subteam-info">
                    <h2>Transportation Logistics Subteam Overview:</h2>
                    <p>
                ...
                {/* Facilities and Safety Subteam */}
                <div className="subteam-info">
                    <h2>Facilities and Safety Subteam Overview:</h2>
                    <p>
                ...
                {/* Computer Science Team Member Subteam */}
                <div className="subteam-info">
                    <h2>Computer Science Team Member Subteam Overview:</h2>
                    <p>
